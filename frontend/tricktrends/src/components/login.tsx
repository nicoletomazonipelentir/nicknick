...
export default function EnhancedLoginPage() {
  ...
  <div className="rounded-md shadow-sm space-y-4">
    <div>
      ...
      <Input
        ...
        value={email}
        placeholder="Email"
        className="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 focus:outline-none focus:ring-green-500 focus:border-green-500 focus:z-10 sm:text-sm"
      />
    </div>
    <div>
  ...
  <div>
    <Button
      ...
      style={{ backgroundColor: "#344e41", hover: { backgroundColor: "#2a3d33" } }}
      disabled={isLoading}
    >
